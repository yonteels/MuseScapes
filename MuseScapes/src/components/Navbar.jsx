            ...
            <div className="container px-6 py-4 mx-auto">
                <div className="lg:flex lg:items-center lg:justify-between">
                    <div className="flex items-center justify-between">
                        <Link to= "/">
                            <img className="w-auto h-11 sm:h-11" src={logo} alt="Logo"/>
                        </Link>
                    ...
                    <div className="hidden lg:flex lg:items-center lg:w-auto">
                        <div className="flex flex-col -mx-6 lg:flex-row lg:items-center lg:mx-8">
                            ...
                            <Link to = "/Contact" className="px-3 py-2 mx-3 mt-2 text-gray-700 transition-colors duration-300 transform rounded-md lg:mt-0 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700">Contact</Link>
                            <Link to = "/Signup" className="px-3 py-2 mx-3 mt-2 text-gray-700 transition-colors duration-300 transform rounded-md lg:mt-0 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700">Sign Up</Link>
                        ...
                        <div className="flex items-center mt-4 lg:mt-0">
                            ...
                            <button type="button" className="flex items-center focus:outline-none" aria-label="toggle profile dropdown">
                                <div className="w-8 h-8 overflow-hidden border-2 border-gray-400 rounded-full">
                                    {isLoggedIn? <img src="" className="object-cover w-full h-full" alt="avatar"/>: <img src="" className="object-cover w-full h-full" alt="avatar"/>}
                                </div>
